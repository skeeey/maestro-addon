...
func (s *CreateOnlyWatcherStore) List(namespace string, opts metav1.ListOptions) ([]*workv1.ManifestWork, error) {
	return nil, fmt.Errorf("unsupported")
}
...
func (s *CreateOnlyWatcherStore) Get(namespace, name string) (*workv1.ManifestWork, error) {
