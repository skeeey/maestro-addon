...
var _ store.ClientWatcherStore[*workv1.ManifestWork] = &CreateOnlyWatcherStore{}
...
func (s *CreateOnlyWatcherStore) List(
	namespace string, opts metav1.ListOptions) (*store.ResourceList[*workv1.ManifestWork], error) {
	return nil, fmt.Errorf("unsupported")
}
